...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2020 at 10:47 PM
...
(45, 35, 'lala', '123456789', 'surat dinas', 'tugas negara', 'jurnal2.docx', 1);
...
(58, 33, 'Lievia Anjhelina Maharani', 'Bogor', '1998-08-28', '161105150552', '8', 'surat keterangan aktif', 'kp', '2020-07-18', '2020-07-20', 1);
...
INSERT INTO `notif` (`id_notif`, `user_id`, `pesan`, `status`) VALUES
(94, 33, 'surat keterangan aktif', 0),
(95, 35, 'surat dinas', 0);
...
--
ALTER TABLE `form_dosen`
  MODIFY `id_dosen` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT for table `form_mahasiswa`
--
ALTER TABLE `form_mahasiswa`
  MODIFY `id_mhs` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `notif`
  MODIFY `id_notif` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
