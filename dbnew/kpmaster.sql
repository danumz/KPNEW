...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 22, 2020 at 03:21 AM
...
(1, 35, 'lala', '123456789', 'surat dinas', 'keperluan tertentu', 'jurnal5.docx', 0);
...
(1, 33, 'Lievia Anjhelina Maharani', 'Bogor', '1998-08-28', '161105150552', '8', 'Transkip nilai', 'Sidang Skripsi', '2020-07-20', '2020-07-22', 1);
...
INSERT INTO `notif` (`id_notif`, `user_id`, `nama`, `mhs_id`, `dosen_id`, `pesan`, `status`) VALUES
(103, 35, 'lala', NULL, 1, 'surat dinas', 0);
...
ALTER TABLE `notif`
  ...
  ADD KEY `mhs_id` (`mhs_id`,`dosen_id`),
...
--
ALTER TABLE `memo`
  MODIFY `id_memo` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `notif`
--
ALTER TABLE `notif`
  MODIFY `id_notif` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
...
ALTER TABLE `notif`
  ...
  ADD CONSTRAINT `notif_ibfk_2` FOREIGN KEY (`mhs_id`) REFERENCES `form_mahasiswa` (`id_mhs`),
  ADD CONSTRAINT `notif_ibfk_3` FOREIGN KEY (`dosen_id`) REFERENCES `form_dosen` (`id_dosen`);
